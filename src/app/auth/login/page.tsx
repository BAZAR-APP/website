  ...
  return (
    <div className='flex flex-col items-center justify-center h-[100%]'>
      <div className='max-w-[360px] flex flex-col gap-[24px]'>
        ...
        <CommonInput icon={<Image src={"/images/countryFlag.svg"} alt='' className='w-[16px] h-[16px]' />} prefix='+965' name="phone" className={'!bg-[#F9FAFB] !text-[#484A4C] !rounded-[8px] !border-none !h-[42px]'} placeholder='Enter your phone number' type='number' label='Phone' onChange={handleChange} />
