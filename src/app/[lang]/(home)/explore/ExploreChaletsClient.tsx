...
interface ExploreChaletsClientProps {
  lang: Locale
  messages: {
    searchHeader: {
      location: string
...
export default function ExploreChaletsClient({ lang, messages }: ExploreChaletsClientProps) {
  ...
  return (
    <div className="min-h-screen lg:px-14 md:px-12 px-10 xxl-p mx-auto">
      ...
      <div className="flex lg:flex-row flex-col py-6 gap-1 xxl-gap">
        <FilterSidebar lang={lang} messages={messages?.filter} searchHeaderMessages={messages.searchHeader}  />
        <div className="full-width">
          <SearchHeader lang={lang} messages={messages.searchHeader} />
          <SearchResults
            location={city || ''}
