  ...
  return (
    <>
      <footer className="flex flex-col m-4 md:m-10 p-8 md:p-16 gap-8 bg-[#F9FAFB] rounded-[20px] md:rounded-[40px]">
        <div className="flex flex-col md:flex-row w-full justify-between flex-wrap gap-10">
          ...
          <div className="flex flex-col sm:flex-row gap-10 flex-grow justify-between">
            <QuickLinks />
            <ContactInfo />
          </div>
