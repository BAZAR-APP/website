...
export const PropertyCardSkeleton: React.FC<{ flexRow?: boolean }> = ({ flexRow }) => {
  return (
    <div
      className={`flex w-[300px] flex-${flexRow ? 'row' : 'col'} items-start gap-6 relative bg-gray-50 p-3 rounded-2xl max-md:w-full`}
    >
