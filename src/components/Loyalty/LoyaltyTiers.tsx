  ...
  return (
    <>
        ...
        <div className="flex flex-col items-start gap-8 w-full">
          <div className="flex flex-col md:flex-row justify-between w-full gap-4 md:gap-0">
            <div className="flex flex-col gap-2 sm:gap-4 max-w-full md:max-w-lg">
              <h1 className="text-[32px] md:text-3xl lg:text-[39px] font-[600] text-[#19191A] leading-tight">
                Loyalty Tiers
              </h1>
            ...
            <div className="flex items-center">
              <Button
                ...
                onClick={toggle}
              >
                Compare Between Tiers <ArrowUpRight size={14} strokeWidth={3} />
              </Button>
            </div>
          </div>
      ...
      <ModalDialog
        ...
        isOpen={isOpen}
        setIsOpen={toggle}
        className="w-full max-w-[80%] lg:max-w-[1050px] max-h-[calc(100vh-100px)] overflow-y-auto m-4 py-2"
      >
        <CompareTiers />
      </ModalDialog>
    </>
