...
export const LoyaltyTiers: React.FC = () => {
    ...
    return (
        <>
                ...
                <div className="flex flex-col items-start gap-8 w-full max-w-screen-xl">
                    <div className="flex flex-col md:flex-row justify-between w-full gap-4 md:gap-0">
                        ...
                        <div className="flex items-center">
                            <Button className="!bg-gray-100 !text-primary whitespace-nowrap px-3 py-2 text-xs sm:text-sm md:text-base flex items-center gap-1 sm:gap-2" onClick={toggle}>
            ...
            <ModalDialog title={"Compare Between Tiers"} isOpen={isOpen} setIsOpen={toggle} className="!max-w-[1050] !w-full !h-[630px] mx-4">
                <CompareTiers />
            </ModalDialog >
