...
const SearchHeader = () => {
  return (
    <div className="flex flex-col md:flex-row items-center py-4 gap-7 bg-[#F9FAFB] md:rounded-full rounded-xl px-3 w-auto md:w-full mx-2">
      ...
      <Button className="w-full md:w-12 md:h-12 sm:w-14 sm:h-14 cursor-pointer bg-[#29397E] !rounded-full flex items-center justify-center hover:bg-blue-900 transition">
