...
interface ProfileBillingProps {
  messages: {
    ...
    billing_items: BillingItem[]; // Add the new billing items array
  };
  // lang: Locale; // Not directly used in this component if data is in messages
}
    ...
    return (
        <>
            ...
            <div className="grid gap-6">
                {messages.billing_items.map((item) => (
