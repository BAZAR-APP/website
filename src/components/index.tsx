...
export { default as ForgetPasswordVerify } from './Auth/ForgetPassword/ForgetPassword';
export { default as VerifyAccount } from './Auth/SignUp/VerifyAccount/VerifyAccount';
