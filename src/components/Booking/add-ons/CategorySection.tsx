...
export const CategorySection: React.FC<CategorySectionProps> = ({
  ...
  return (
    <div className="flex flex-col items-start relative">
      <div className="flex w-[375px] flex-col items-start gap-4 relative pt-2 pb-0 px-4 max-md:w-full max-md:max-w-screen-md max-sm:w-full max-sm:max-w-full">
      ...
      {isOpen && (
        <div className="flex w-[375px] flex-col items-start gap-4 relative px-4 py-3 max-md:w-full max-md:max-w-screen-md max-sm:w-full max-sm:max-w-full">
