...
export const AddOnCard: React.FC<AddOnCardProps> = ({
  ...
  return (
    <div className="flex flex-col items-start gap-3 self-stretch relative bg-gray-50 px-6 py-4 rounded-2xl">
      ...
      <div className="w-full h-px relative bg-[#DEDEDF]" />
      <div className="flex items-start gap-4 self-stretch relative">
          ...
          {quantity !== undefined ? (
            <div className="flex items-center gap-2 relative">
              <button
                ...
                className="flex w-8 h-8 justify-center items-center relative p-[6.4px] rounded-[80px] border-[0.8px] border-solid border-[#E5E5EA]"
            ...
            <button
              onClick={onAdd}
              className="flex w-20 justify-center items-center gap-2 border border-solid relative px-3 py-2 rounded-lg"
            >
