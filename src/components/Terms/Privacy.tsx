    ...
    return (
        <div className="main-container flex flex-col gap-10 justify-center items-start bg-white relative overflow-hidden mx-auto px-5 py-10 max-w-screen-xl">
            ...
            <div className="flex flex-col gap-4 items-start w-full max-w-full sm:max-w-[921px]">
                ...
                <span className="text-base sm:text-lg leading-6 text-[#484a4c]">
            ...
            <div className="flex flex-col gap-6 items-start w-full max-w-full sm:max-w-[698px] z-10">
                <div className="flex flex-col gap-6 w-full">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        <span className="text-base font-medium leading-6 text-[#19191a] whitespace-nowrap">
                            1. Information We Collect
                        </span>
                        <span className="text-base font-normal leading-5 text-[#484a4c]">
                            We may collect the following types of information:
                            <br /><br />
                            <ul className="list-disc pl-8 mr-4 max-w-full">
                ...
                <div className="flex flex-col gap-6 w-full mb-8">
                    <span className="text-lg font-semibold leading-7 text-[#19191a]">
