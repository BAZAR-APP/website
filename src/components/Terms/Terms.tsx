    ...
    return (
        <main className="flex flex-col justify-center items-start gap-10 bg-white px-6 py-12 md:px-16 md:py-16 sm:gap-8 sm:px-4 sm:py-6">
            <header className="w-full max-w-4xl flex flex-col items-start gap-4">
                <h1 className="text-[#19191A] text-3xl md:text-4xl font-bold">
                    Terms & Conditions
                </h1>
                <p className="text-[#484A4C] text-base md:text-lg">
            ...
            <article className="w-full max-w-3xl flex flex-col items-start gap-6">
                {termsData.map((term) => (
