...
export const bookingCardsData = [
  {
    id: 'luxury-lakeside-1',
  ...
  },
  {
    ...
    beds: 3,
    baths: 2,
    amenities: ['Fireplace', 'Trails', 'Property Interior'],
    dateRange: {
      from: '15 April 2025',
      to: '18 April 2025',
    },
    imageUrl: 'https://picsum.photos/seed/mountain/311/190',
  ...
  },
  {
    ...
    beds: 3,
    baths: 2,
    amenities: ['Fireplace', 'Hiking', 'Home Friendly'],
    dateRange: {
      from: '10 May 2025',
      to: '14 May 2025',
    },
    imageUrl: 'https://picsum.photos/seed/beach/311/190',
    imageAlt: 'Beachside Villa View',
    rating: 5.0,
    reviews: 212,
    member: true,
  },
